...
export default function EmployeeCertificatesPage() {
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      doc.setFontSize(11);
      doc.setFont('helvetica', 'normal');
      const authText = `This certificate hereby authorizes ${certificate.employee_name} to act as an official employee of ${certificate.company_name} and to provide services and assistance to customers on behalf of the company. This authorization is valid from the date of issue and remains active as long as the employee maintains good standing with the company.`;
      ...
      doc.setFontSize(10);
      doc.setFont('helvetica', 'normal');
      doc.text(`Digital Signature: ${certificate.digital_signature}`, 105, 235, { align: 'center' });
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-center">
          ...
          `}</style>
          <Card className="border-4 border-red-600 shadow-2xl print:shadow-none print:border-4 print:border-red-600 print-certificate">
            <CardContent className="p-12 print:p-8 print-border">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  {/* Employee Details */}
                  {(certificate.employee_id || certificate.department) && (
