...
export async function POST(request: NextRequest) {
  try {
    ...
    // Admin email address
    const adminEmail = process.env.ADMIN_EMAIL || 'admin@vignahartajanseva.gov.in';
    ...
    <head>
        ...
        <title>Support Request - विघ्नहर्ता जनसेवा</title>
        <style>
            body {
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="action-buttons">
                    ...
                    <a href="tel:+919819399470" class="btn btn-secondary">📞 Call Support</a>
                </div>
            </div>
            
            <div class="footer">
                <p class="footer-text">🏛️ विघ्नहर्ता जनसेवा - Government Services Portal</p>
                <p class="footer-text">📞 Support: +91-9819399470 | 📧 admin@vignahartajanseva.gov.in</p>
                <p class="footer-text">🌐 Serving citizens with dedication and transparency</p>
                <p class="footer-text" style="margin-top: 15px; border-top: 1px solid #e5e7eb; padding-top: 15px;">
                    <a href="https://akrix-ai.netlify.app/" target="_blank" style="color: #dc2626; text-decoration: none; font-weight: 600;">
                        Dynamic Email System By ❤️ Akrix.ai ❤️
                    </a>
                </p>
            </div>
        </div>
