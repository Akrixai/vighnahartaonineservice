          ...
          <div className="border-t border-white/20 pt-8 animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-white font-medium text-lg">
                © 2024 विघ्नहर्ता जनसेवा. All rights reserved.
              </p>
              <div className="flex items-center space-x-4">
                ...
                <a
                  ...
                  className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-4 py-2 rounded-full font-bold animate-pulse hover:from-orange-500 hover:to-yellow-400 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                >
                  ⚡ Akrix AI
                </a>
              </div>
