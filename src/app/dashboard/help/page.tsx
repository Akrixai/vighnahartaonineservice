              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-lg font-semibold">📧 support@vignaharta.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <div className="font-medium text-gray-900">Toll-Free Number</div>
                    <div className="text-blue-600 font-mono">1800-123-4567</div>
                  </div>
                  <div>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-blue-600">support@vignahartajanseva.gov.in</div>
                  </div>
                  <div>
                    <div className="font-medium text-gray-900">Technical Issues</div>
                    <div className="text-blue-600">tech@vignahartajanseva.gov.in</div>
                  </div>
                  <div>
