            ...
            <div className="relative p-10 bg-gradient-to-br from-red-600 via-red-700 to-red-800 rounded-3xl shadow-2xl max-w-4xl mx-auto hover-lift animate-fade-in text-white overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Link
                    href="/register"
                    className="group relative inline-flex items-center justify-center px-10 py-5 bg-white text-red-600 rounded-2xl hover:bg-yellow-300 hover:text-red-800 transition-all duration-300 font-bold shadow-2xl hover:shadow-yellow-300/50 transform hover:scale-105 text-lg overflow-hidden cta-button border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
                  ...
                  <Link
                    href="/about"
                    className="group inline-flex items-center justify-center px-10 py-5 border-3 border-white text-white rounded-2xl hover:bg-white hover:text-red-600 transition-all duration-300 font-bold shadow-2xl hover:shadow-white/50 transform hover:scale-105 text-lg cta-button border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
