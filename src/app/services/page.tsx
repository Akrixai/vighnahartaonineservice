...
export const metadata: Metadata = {
  title: "Services - Vignaharta Janseva | Government Service Portal",
  description: "Explore comprehensive government services available through Vignaharta Janseva including Aadhaar, PAN, passport, certificates, and more.",
  keywords: "government services, aadhaar card, pan card, passport, certificates, digital services, online applications",
  openGraph: {
    title: "Government Services - Vignaharta Janseva",
    description: "Access all essential government services digitally through our secure platform with real-time tracking and support.",
    type: "website",
  },
};
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Find your nearest Vignaharta Janseva retailer</p>
            </div>
            <div className="text-center">
              <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
