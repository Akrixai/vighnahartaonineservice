      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mt-8 p-4 bg-white rounded-lg shadow-md animate-fade-in">
          ...
          <div className="flex justify-center space-x-4 text-sm">
            <a href="mailto:support@vignahartajanseva.gov.in" className="text-red-600 hover:text-red-700">
              📧 Email Support
            </a>
            <a href="tel:+911800123456" className="text-red-600 hover:text-red-700">
              📞 Call Support
            </a>
          </div>
        </div>
